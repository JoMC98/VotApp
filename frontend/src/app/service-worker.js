    ...
    class Driver {
        ...
        handlePush(data) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (desc['identifier'] && desc['identifier'] == "votappDATA") {
                    //LLAMADA A NOTIFICACION PROPIA
                    let opciones = {"body": desc.body, "actions": ACTIONS, "badge": BADGE, "icon": ICON};
                    let options = {};
                    
                    NOTIFICATION_OPTION_NAMES.filter(name => opciones.hasOwnProperty(name))
                        .forEach(name => options[name] = opciones[name]);
